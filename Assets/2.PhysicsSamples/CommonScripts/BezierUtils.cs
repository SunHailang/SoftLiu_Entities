...
namespace CommonScripts
{
    public class BezierUtils
    {
        ...
        /// <param name="segmentNum">采样点数量</param>
        /// <returns></returns>
        public static Vector3[] GetLineBezierList(Vector3 startPoint, Vector3 controlPoint, Vector3 endPoint, int segmentNum)
        {
            segmentNum += 2;
            Vector3[] paths = new Vector3[segmentNum];
            paths[0] = startPoint;
        ...
        /// <param name="segmentNum">采样点数量</param>
        /// <returns></returns>
        public static Vector3[] GetLineBezierList(Vector3 startPoint, Vector3 controlPoint1, Vector3 controlPoint2, Vector3 endPoint, int segmentNum)
        {
            segmentNum += 2;
            Vector3[] paths = new Vector3[segmentNum];
            paths[0] = startPoint;
        ...
        public static Vector3[] GetLineBezierList(List<Vector3> pointList, int segmentNum)
        {
        ...
        private static Vector3 BezierInterpolation(float t, List<Vector3> points, int count)
        {
            ...
            {
                var temp = CalcCombinationNumber(count - 1, i);
